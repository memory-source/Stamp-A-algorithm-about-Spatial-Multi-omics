"""
Fast regenerate spatial domain plots with 'Predicted Domain 1/2/3/4' legend.
Uses existing stamp_domain from h5ad files.
"""
import os
import sys
import numpy as np
...
def fix_and_plot(dataset_idx, fig_dir, v7a_label=True):
    ...
    # Create mapped cluster names for consistent colors with GT
    ...
    title_left = f'STAMP Domain (ARI={ari:.3f})'
...
# Regenerate for both directories
for d in range(1, 6):
...
print("[DONE] All spatial domain plots regenerated with updated legends.")
